...
namespace BusinessModels
{
    ...
    public static class Literals
    {
        ...
        public static string invalidUsername = "***********Please enter username with starting with _/a-z/A-Z ***********";
        public static string invalidEmail = "**********Please enter email ending with @gmail.com***********";
        public static string invalidPassword = "***********Please enter password having a-z and A-Z and 0-9***********";
        public static string invalidMobileNumber = "**********Please enter the number*********";
